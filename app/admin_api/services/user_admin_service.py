...
from app.admin_api.repositories.user_admin_repository import UserAdminRepository
from app.admin_api.schemas.user import (
    AdminAddressOut,
    AdminPreferencesOut,
    AdminProfileOut,
    AdminUserDetailOut,
...
def _get_r2_client() -> R2Client | None:
    ...
    if _r2_client is None:
        _r2_client = R2Client(
            endpoint_url=settings.r2_endpoint or settings.r2_endpoint_url,
