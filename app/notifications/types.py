...
class NotificationType(StrEnum):
    ...
    MARKETING_BROADCAST_IMAGE = "MARKETING_BROADCAST_IMAGE"
    MARKETING_BROADCAST_VIDEO = "MARKETING_BROADCAST_VIDEO"
...
MARKETING_TYPES = frozenset(
    {
        ...
        NotificationType.MARKETING_BROADCAST_IMAGE,
        NotificationType.MARKETING_BROADCAST_VIDEO,
